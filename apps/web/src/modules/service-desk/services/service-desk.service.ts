...
export const seedServiceRequests: ServiceRequest[] = [
  {
    ...
    priority: "high",
    customerId: "c-1",
    customer: { id: "c-1", name: "Bright Mart", company: "Bright Mart LLC" },
    businessId: "b-1",
    business: { id: "b-1", name: "Bright Mart LLC" },
    assignedTechnician: { id: "t-1", name: "Ava Stone", specialty: "Hardware" },
  ...
  },
  {
    ...
    priority: "medium",
    customerId: "c-2",
    customer: { id: "c-2", name: "Northgate Logistics" },
    assignedTechnician: { id: "t-2", name: "Leo Park", specialty: "Network" },
  ...
  },
  {
    ...
    priority: "low",
    customerId: "c-3",
    customer: { id: "c-3", name: "Coral Books" },
  ...
  },
  {
    ...
    customerId: "c-2",
    customer: { id: "c-2", name: "Northgate Logistics" },
    assignedTechnician: { id: "t-3", name: "Mia Chen", specialty: "Facilities" },
